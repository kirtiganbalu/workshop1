...
namespace matplotlibcpppayment {
    namespace detail {
...
#  endif
    ...
    template <typename Numeric>
    bool bar(const std::vector<DOUBLE>& y,
        std::string                                ec = "black",
        std::string                                ls = "-",
        double                                     lw = 1.0,
        const std::map<std::string, std::string>& keywords = {})
    ...
    template<typename Numeric>
    bool barh(const std::vector<Numeric>& x, const std::vector<DOUBLE>& y, std::string ec = "black", std::string ls = "-", double lw = 1.0, const std::map<std::string, std::string>& keywords = { }) {
        PyObject* xarray = detail::get_array(x);
        PyObject* yarray = detail::get_array(y);
    ...
    template<typename Numeric>
    void text(Numeric x, double y, const std::double_t& s = "")
    {
        detail::_interpreter::get();
        ...
        PyTuple_SetItem(args, 2, PyFloat_FromDouble(s));
